...
import com.teraninja.mohamy.Model.SittingsOfTrial;
...
public class AdapterSittingLastandNext extends RecyclerView.Adapter<AdapterSittingLastandNext.ViewHolder>{
    ArrayList<LastSiting> list = new ArrayList<>();

    OnClickId onClickId;

    public AdapterSittingLastandNext(OnClickId onClickId) {
    ...
    public void getList(ArrayList<LastSiting> list) {
        this.list=list;
