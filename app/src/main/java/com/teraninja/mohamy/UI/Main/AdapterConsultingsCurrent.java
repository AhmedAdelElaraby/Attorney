...
public class AdapterConsultingsCurrent extends RecyclerView.Adapter<AdapterConsultingsCurrent.ViewHolder>{
    ArrayList<CurrentConsulting> list = new ArrayList<>();
    ...
    public void getList(ArrayList<CurrentConsulting> list) {
        this.list=list;
